...
// Handle reservation cancellation
  if (isset($_POST['cancel_reservation'])) {
    ...
    $cancel_reservation_query = "DELETE FROM reservations WHERE id = '$reservation_id' AND user_name = '$user_name'";
    if ($conn->query($cancel_reservation_query) === TRUE) {
  ...
  $reservations_query = "SELECT r.id, r.reserved_on, g.name AS rentplace_name FROM reservations r JOIN garages g ON r.id = g.id WHERE r.user_name='$user_name'";
...
<body>
  ...
  padding: 20px;">
    ...
    <div class="content">
          ...
          <tbody>
            <?php foreach ($reservations as $reservation) { ?>
              <tr>
                ...
                <td><?php echo $reservation['rentplace_name']; ?></td>
      ...
      <?php } else { ?>
        <div style="color: black; text-align: center; border:  border-bottom: none; border-radius: 10px 10px 0px 0px; padding: 20px;">
        <p>No reservations.</p>
      </div>
      <?php } ?>
    </div>
