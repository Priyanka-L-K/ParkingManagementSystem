...
// Handle reservation cancellation
  if (isset($_POST['cancel_reservation'])) {
    ...
    $cancel_reservation_query = "DELETE FROM rent_reservations WHERE id = '$reservation_id' AND user_name = '$user_name'";
  ...
  $reservations_query = "SELECT r.id, r.reserved_on, g.name AS rentplace_name FROM rent_reservations r JOIN rentplace g ON r.rentplace_id = g.id WHERE r.user_name='$user_name'";
